...
<body>
                  ...
                  <div id="insert_type_track">


            <form action="insert_type_track.php" method="post" enctype="multipart/form-data">
              
			              
						  
						  <table width="700" border="5" align="center" bgcolor="#feeaf9">
						  
						  
						  <tr>
						  
						  <td bgcolor="#e78a05"  colspan="2"><h2><center>ENTER Type of Track</center></h2></td>
						  </tr>
...
<?php
			...
			$insert_product= "insert into singer (s_id, s_name, s_add, s_state, s_count, s_t, s_f, tot_album, album_a_id) 
			values('$s_id','$s_name','$address','$state','$country','$s_twitter', '$s_facebook', '$total_albums', '$album_a_id')";
