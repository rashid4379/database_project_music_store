...
if (isset($_POST['submit'])) {
   ...
   // $as_id=$_POST['as_id'];
    ...
    $insert = "INSERT INTO video_songs (singer_id,album_id,vs_name,vs_upload_date)values($singer_id,$album_id,'$as_name',now())";
    $query= mysqli_query ($connection,$insert);

    if($query)
    {
        echo "<script>alert('record has been entered')</script>";
        echo "<script>window.openalert('add_video.php','_self')</script>";
    }
    else
    {
        ...
        <ul style="background-color: black;" >
            ...
            <li style="padding-left: 60px;">
             ...
             <ul>
               ...
               <div class="container">
  <h2 style="color: white">Add Video Songs</h2>

  <!-- form start here -->
  <form class="form-horizontal" method='post' action='add_video.php'  enctype='multipart/form-data' >
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="email" style="color: white">Video Song Name:</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" name="vs_name" placeholder="Enter audio Song name">
      </div>
    </div>
      <!--<div class="form-group">
