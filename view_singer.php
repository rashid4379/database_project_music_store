            ...
            <li style="padding-left: 60px;">
             ...
             <ul>
                ...
                <section class="content-header">
                  ...
                  <h1  style="font-family:'Century Gothic'"><i class=" fa fa-users fa-1x"></i>View Singers</h1>
                ...
                <section class="content">
                  ...
                  <th style="...">Property Description</th>
                            ...
                            <tbody>
                                <?php
                                $query= mysqli_query($connection,"select * from singers");
                                while($row= mysqli_fetch_array($query))
                                {  ?>
                                    <tr style="color: white">
                                    <td> <?php echo $row['singer_id']; ?></td> 
                                    <td> <?php echo $row['singer_name'];?></td>
                                    <td> <?php echo $row['singer_description']; ?></td>
                                    
                                    <td>
                                        
                    
                    <form method='post' action='edit_singer_records.php'>
