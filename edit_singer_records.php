...
if (isset($_POST['update'])) {
    ...
    $update="update singers set singer_name='$singer_name',singer_description='$singer_description' where singer_id='$singer_id'";
  ...
  <!-- form start here -->
    <div class="row" style="margin-left: 10px; margin-top: 10px">
            <section class="col-md-10 connectedSortable">
              ...
              {
                $singer_id= $_POST['val'];
                $queryg= mysqli_query($connection,"select * from singers where singer_id='$singer_id'");
                  ...
                  echo "
                    <div class='panel panel-default'>
                        ...
                        <div class='panel-body'>";
                            ...
                            <form class='form-horizontal' method='post' enctype=\"multipart/form-data\">
                                  ...
                                  <div class='form-group'>
                                    ...
                                    <div class='col-sm-10'>
                                      <input type='hidden' class='form-control' name='singer_id' value='",$grow['singer_id'],"'>
                                    </div>
                                  </div>
                        ...
                        <div class='form-group'>
                                    ...
                                    <div class='col-sm-10'>
                                      <input type='text' class='form-control' name='singer_name' value='", $grow['singer_name'],"'>
                                   ...
                                   <div class='form-group'>
                                    ...
                                    <div class='col-sm-10'>
                                     <input type='text' class='form-control' name='singer_description' value='", $grow['singer_description'],"'>
                                    </div>
                                  </div>";
